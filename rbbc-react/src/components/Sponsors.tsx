          ...
          {sponsors.map((sponsor, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative h-24 sm:h-28 md:h-32 bg-white rounded-sm overflow-hidden border border-white/10 hover:border-red-700/40 transition-colors duration-300"
              >
                {inner}
              </motion.div>
            )
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="p-6 bg-surface border border-white/10 rounded-sm hover:border-red-700/30 transition-colors duration-300 group"
              >
