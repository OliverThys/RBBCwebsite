          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <p className="font-semibold text-sm" style={{ color: DARK }}>{contactInfo.committee.name}</p>
                  <p className="text-gray-500 text-xs uppercase tracking-widest">Comité</p>
                </div>
              </div>
              <div className="space-y-3">
                ...
                <a href={`mailto:${contactInfo.committee.email}`} className="flex items-center gap-3 group">
                  ...
                  <span className="text-gray-700 group-hover:text-gray-900 text-sm transition-colors break-all">{contactInfo.committee.email}</span>
                </a>
              </div>
            </motion.div>
