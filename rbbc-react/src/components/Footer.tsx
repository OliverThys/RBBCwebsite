...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/BlaregniesBasketClub/',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/royalblaregniesbasketclub?igsh=MTh4eXVzeGp4Z3lmMw==',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-off-black border-t border-white/8">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-red-700/40">
                <img
              ...
              <div>
                <div className="font-display text-xl text-white">RBBC</div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <p className="flex items-start gap-2 text-white/30">
                ...
                Rue de Blaregnies 1C,<br />7040 Blaregnies
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 text-white/40 hover:text-white text-xs uppercase tracking-widest transition-colors duration-200 group"
          >
            Retour en haut
